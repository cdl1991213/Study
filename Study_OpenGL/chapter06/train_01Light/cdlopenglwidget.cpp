...
//    view.translate(0.0, 0.0, -5.0);     //摄像机位于z=3的位置
    ...
    //model
    model.rotate(time1, 1.0f, 5.0f, 0.5f);   //自转，绕y轴旋转
    ShaderProgram.setUniformValue("model", model);
    //物体材质
    ShaderProgram.setUniformValue("material.ambient", 0.0f, 0.1f, 0.06f);
    ShaderProgram.setUniformValue("material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
    ShaderProgram.setUniformValue("material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
...
//    ShaderProgram.setUniformValue("light.specular", QVector3D(1.0, 1.0, 1.0));
    ShaderProgram.setUniformValue("light.ambient", 1.0f, 1.0f, 1.0f);
    ShaderProgram.setUniformValue("light.diffuse", 1.0f, 1.0f, 1.0f);
