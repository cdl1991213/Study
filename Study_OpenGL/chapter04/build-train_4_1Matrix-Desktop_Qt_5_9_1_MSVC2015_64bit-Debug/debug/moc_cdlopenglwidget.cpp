...
#include "../../train_4_1Matrix/cdlopenglwidget.h"
...
void cdlOpenGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        cdlOpenGLWidget *_t = static_cast<cdlOpenGLWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject cdlOpenGLWidget::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_cdlOpenGLWidget.data,
      qt_meta_data_cdlOpenGLWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *cdlOpenGLWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cdlOpenGLWidget.stringdata0))
        return static_cast<void*>(const_cast< cdlOpenGLWidget*>(this));
    if (!strcmp(_clname, "QOpenGLFunctions_4_5_Core"))
        return static_cast< QOpenGLFunctions_4_5_Core*>(const_cast< cdlOpenGLWidget*>(this));
